...
define gui.accent_color = '#FFF6E9'
...
define gui.hover_color = '#C69D7B'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#F7ECDA'
...
define gui.text_font = "fonts/LumiosTypewriter-Old.ttf"
